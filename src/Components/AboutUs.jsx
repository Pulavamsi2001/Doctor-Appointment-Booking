      ...
      <div className='flex flex-col md:flex-row justify-around gap-10'>
        ...
        <div className='text-sm'>
          <p className='w-full md:w-4/5 h-full align-middle'>
            Welcome to DocFinder, your trusted partner in managing your healthcare needs conveniently and efficiently. At DocFinder, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.
            <br /> <br />
            DocFinder is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, DocFinder is here to support you every step of the way.
          </p>
        </div>
      </div>
